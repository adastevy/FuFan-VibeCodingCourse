...
import { interceptWriterCompletion } from '../content-generation/writer-interceptor.js';
...
export async function routeAgentMessage(msg: RoutableAgentMessage, session: Session): Promise<void> {
  ...
  // Host-side persistence: catch writer completion messages and INSERT to
  // content_articles directly, bypassing any LLM tool-call failure.
  interceptWriterCompletion(session.agent_group_id, targetAgentGroupId, msg.content);
